...
public:
    ...
    {
        assert(runway_num < runways.size() && "Our runway cannot be > of runway number");
        assert(terminal_num < terminal_pos.size() && "Our terminal length cannot exceed our terminal's number");
